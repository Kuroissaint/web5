...
const SearchReportScreen = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      formData.append('lokasi_detail', form.lokasi_detail);
      formData.append('deskripsi', form.deskripsi);
      formData.append('provinsi_id', String(region.provinsiId));
      formData.append('kota_id', String(region.kotaId));
      formData.append('kecamatan_id', String(region.kecamatanId));
      formData.append('tags', JSON.stringify(selectedTags));

      // Pengolahan file foto untuk backend
      ...
      console.error(error);
      Alert.alert("Gagal Mengirim", "Cek koneksi internet atau server kamu.");
    } finally {
      setLoading(false);
    }
  };
